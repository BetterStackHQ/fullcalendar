...
function computeEventForDateSpan(dateSpan, dragMeta, context) {
    ...
    var def = parseEventDef(refined, extra, dragMeta.sourceId, dragMeta.allDay && dateSpan.allDay, context.options.forceEventDuration || Boolean(dragMeta.duration), // hasEnd
    context);
